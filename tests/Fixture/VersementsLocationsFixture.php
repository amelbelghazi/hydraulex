...
/**
 * VersementsLocationsFixture
 *
 */
class VersementsLocationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dateversement' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'montant' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'dettes_location_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'dateversement' => '2018-03-08',
            'montant' => 1,
            'dettes_location_id' => 1,
            'created' => '2018-03-08',
            'modified' => '2018-03-08',
            'modified_by' => 1
        ],
