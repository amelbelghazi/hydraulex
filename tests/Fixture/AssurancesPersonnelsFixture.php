...
/**
 * AssurancesPersonnelsFixture
 *
 */
class AssurancesPersonnelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'assurance_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'dateassurance' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
