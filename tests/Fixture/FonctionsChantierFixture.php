...
/**
 * FonctionsChantierFixture
 *
 */
class FonctionsChantierFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'fonctions_chantier';
    ...
    public $fields = [
        ...
        'fonction_id' => ['type' => 'string', 'length' => 250, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'fonction_id' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-12-24',
            'modified' => '2017-12-24',
            'modified_by' => 1
        ],
