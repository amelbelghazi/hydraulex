...
/**
 * SituationsFamillialesFixture
 *
 */
class SituationsFamillialesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'libellé' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'libellé' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-12-29',
            'modified' => '2017-12-29',
            'modified_by' => 1
        ],
