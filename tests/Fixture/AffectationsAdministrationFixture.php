...
/**
 * AffectationsAdministrationFixture
 *
 */
class AffectationsAdministrationFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'affectations_administration';
    ...
    public $fields = [
        ...
        'affectation_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
