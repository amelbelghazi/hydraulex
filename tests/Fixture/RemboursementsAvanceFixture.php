...
/**
 * RemboursementsAvanceFixture
 *
 */
class RemboursementsAvanceFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'remboursements_avance';
    ...
    public $fields = [
        ...
        'avance_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
