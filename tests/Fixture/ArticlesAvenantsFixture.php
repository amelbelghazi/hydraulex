...
/**
 * ArticlesAvenantsFixture
 *
 */
class ArticlesAvenantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'parties_avenant_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'intitule' => ['type' => 'string', 'length' => 250, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
