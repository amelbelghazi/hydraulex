...
use App\Model\Table\ArticlesAvenantsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ArticlesAvenantsTable Test Case
 */
class ArticlesAvenantsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ArticlesAvenantsTable
     */
    public $ArticlesAvenants;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ArticlesAvenants') ? [] : ['className' => ArticlesAvenantsTable::class];
        $this->ArticlesAvenants = TableRegistry::get('ArticlesAvenants', $config);
    }
