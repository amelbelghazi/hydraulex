...
use App\Model\Table\SalairesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SalairesTable Test Case
 */
class SalairesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\SalairesTable
     */
    public $Salaires;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Salaires') ? [] : ['className' => SalairesTable::class];
        $this->Salaires = TableRegistry::get('Salaires', $config);
    }
