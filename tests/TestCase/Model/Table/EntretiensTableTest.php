...
use App\Model\Table\EntretiensTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EntretiensTable Test Case
 */
class EntretiensTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EntretiensTable
     */
    public $Entretiens;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Entretiens') ? [] : ['className' => EntretiensTable::class];
        $this->Entretiens = TableRegistry::get('Entretiens', $config);
    }
