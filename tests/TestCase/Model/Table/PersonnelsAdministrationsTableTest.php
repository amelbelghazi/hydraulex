...
use App\Model\Table\PersonnelsAdministrationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PersonnelsAdministrationsTable Test Case
 */
class PersonnelsAdministrationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PersonnelsAdministrationsTable
     */
    public $PersonnelsAdministrations;
     ...
     */
    public $fixtures = [
        'app.personnels_administrations',
        'app.personnels',
        'app.personnes',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PersonnelsAdministrations') ? [] : ['className' => PersonnelsAdministrationsTable::class];
        $this->PersonnelsAdministrations = TableRegistry::get('PersonnelsAdministrations', $config);
    }
    ...
    {
        unset($this->PersonnelsAdministrations);
