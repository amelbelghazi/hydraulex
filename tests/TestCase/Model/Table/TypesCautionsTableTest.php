...
use App\Model\Table\TypesCautionsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TypesCautionsTable Test Case
 */
class TypesCautionsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TypesCautionsTable
     */
    public $TypesCautions;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TypesCautions') ? [] : ['className' => TypesCautionsTable::class];
        $this->TypesCautions = TableRegistry::get('TypesCautions', $config);
    }
