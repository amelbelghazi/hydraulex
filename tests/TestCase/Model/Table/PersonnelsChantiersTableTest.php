...
use App\Model\Table\PersonnelsChantiersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PersonnelsChantiersTable Test Case
 */
class PersonnelsChantiersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PersonnelsChantiersTable
     */
    public $PersonnelsChantiers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PersonnelsChantiers') ? [] : ['className' => PersonnelsChantiersTable::class];
        $this->PersonnelsChantiers = TableRegistry::get('PersonnelsChantiers', $config);
    }
    ...
    {
        unset($this->PersonnelsChantiers);
