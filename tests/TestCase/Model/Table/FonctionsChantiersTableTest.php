...
use App\Model\Table\FonctionsChantiersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\FonctionsChantiersTable Test Case
 */
class FonctionsChantiersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\FonctionsChantiersTable
     */
    public $FonctionsChantiers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('FonctionsChantiers') ? [] : ['className' => FonctionsChantiersTable::class];
        $this->FonctionsChantiers = TableRegistry::get('FonctionsChantiers', $config);
    }
