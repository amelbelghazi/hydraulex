...
use App\Model\Table\ReparationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReparationsTable Test Case
 */
class ReparationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReparationsTable
     */
    public $Reparations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Reparations') ? [] : ['className' => ReparationsTable::class];
        $this->Reparations = TableRegistry::get('Reparations', $config);
    }
