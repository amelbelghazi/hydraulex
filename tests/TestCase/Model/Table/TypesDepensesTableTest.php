...
use App\Model\Table\TypesDepensesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TypesDepensesTable Test Case
 */
class TypesDepensesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TypesDepensesTable
     */
    public $TypesDepenses;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TypesDepenses') ? [] : ['className' => TypesDepensesTable::class];
        $this->TypesDepenses = TableRegistry::get('TypesDepenses', $config);
    }
