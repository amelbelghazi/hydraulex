...
use App\Model\Table\PiecesRessourcesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PiecesRessourcesTable Test Case
 */
class PiecesRessourcesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PiecesRessourcesTable
     */
    public $PiecesRessources;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PiecesRessources') ? [] : ['className' => PiecesRessourcesTable::class];
        $this->PiecesRessources = TableRegistry::get('PiecesRessources', $config);
    }
