...
use App\Model\Table\PannesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PannesTable Test Case
 */
class PannesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PannesTable
     */
    public $Pannes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Pannes') ? [] : ['className' => PannesTable::class];
        $this->Pannes = TableRegistry::get('Pannes', $config);
    }
