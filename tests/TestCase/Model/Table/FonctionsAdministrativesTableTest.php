...
use App\Model\Table\FonctionsAdministrativesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\FonctionsAdministrativesTable Test Case
 */
class FonctionsAdministrativesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\FonctionsAdministrativesTable
     */
    public $FonctionsAdministratives;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('FonctionsAdministratives') ? [] : ['className' => FonctionsAdministrativesTable::class];
        $this->FonctionsAdministratives = TableRegistry::get('FonctionsAdministratives', $config);
    }
    ...
    {
        unset($this->FonctionsAdministratives);
