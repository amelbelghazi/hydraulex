...
use App\Model\Table\DetailsBonReceptionTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DetailsBonReceptionTable Test Case
 */
class DetailsBonReceptionTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DetailsBonReceptionTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DetailsBonReception') ? [] : ['className' => DetailsBonReceptionTable::class];
        $this->DetailsBonReception = TableRegistry::get('DetailsBonReception', $config);
    }
    ...
    {
        unset($this->DetailsBonReception);
