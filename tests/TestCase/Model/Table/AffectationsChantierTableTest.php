...
use App\Model\Table\AffectationsChantierTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AffectationsChantierTable Test Case
 */
class AffectationsChantierTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AffectationsChantierTable
     */
    public $AffectationsChantier;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AffectationsChantier') ? [] : ['className' => AffectationsChantierTable::class];
        $this->AffectationsChantier = TableRegistry::get('AffectationsChantier', $config);
    }
    ...
    {
        unset($this->AffectationsChantier);
