...
use App\Model\Table\PositionsAdministrativesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PositionsAdministrativesTable Test Case
 */
class PositionsAdministrativesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PositionsAdministrativesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PositionsAdministratives') ? [] : ['className' => PositionsAdministrativesTable::class];
        $this->PositionsAdministratives = TableRegistry::get('PositionsAdministratives', $config);
    }
    ...
    {
        unset($this->PositionsAdministratives);
