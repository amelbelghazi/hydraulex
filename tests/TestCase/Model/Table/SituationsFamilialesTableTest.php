...
use App\Model\Table\SituationsFamilialesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SituationsFamilialesTable Test Case
 */
class SituationsFamilialesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\SituationsFamilialesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('SituationsFamiliales') ? [] : ['className' => SituationsFamilialesTable::class];
        $this->SituationsFamiliales = TableRegistry::get('SituationsFamiliales', $config);
    }
    ...
    {
        unset($this->SituationsFamiliales);
