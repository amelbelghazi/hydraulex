...
use App\Model\Table\EntretiensRessourcesPeriodiquesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EntretiensRessourcesPeriodiquesTable Test Case
 */
class EntretiensRessourcesPeriodiquesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EntretiensRessourcesPeriodiquesTable
     */
    public $EntretiensRessourcesPeriodiques;
     ...
     */
    public $fixtures = [
        'app.entretiens_ressources_periodiques',
        'app.entretiens_ressources',
        'app.ressources',
        'app.locations',
        'app.departements',
        'app.societes',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EntretiensRessourcesPeriodiques') ? [] : ['className' => EntretiensRessourcesPeriodiquesTable::class];
        $this->EntretiensRessourcesPeriodiques = TableRegistry::get('EntretiensRessourcesPeriodiques', $config);
    }
    ...
    {
        unset($this->EntretiensRessourcesPeriodiques);
