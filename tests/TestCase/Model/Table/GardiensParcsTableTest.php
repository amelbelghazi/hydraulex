...
use App\Model\Table\GardiensParcsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\GardiensParcsTable Test Case
 */
class GardiensParcsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\GardiensParcsTable
     */
    public $GardiensParcs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('GardiensParcs') ? [] : ['className' => GardiensParcsTable::class];
        $this->GardiensParcs = TableRegistry::get('GardiensParcs', $config);
    }
