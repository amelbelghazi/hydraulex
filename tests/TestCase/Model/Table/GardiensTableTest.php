...
use App\Model\Table\GardiensTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\GardiensTable Test Case
 */
class GardiensTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\GardiensTable
     */
    public $Gardiens;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Gardiens') ? [] : ['className' => GardiensTable::class];
        $this->Gardiens = TableRegistry::get('Gardiens', $config);
    }
