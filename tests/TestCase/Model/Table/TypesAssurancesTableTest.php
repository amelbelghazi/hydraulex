...
use App\Model\Table\TypesAssurancesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TypesAssurancesTable Test Case
 */
class TypesAssurancesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TypesAssurancesTable
     */
    public $TypesAssurances;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TypesAssurances') ? [] : ['className' => TypesAssurancesTable::class];
        $this->TypesAssurances = TableRegistry::get('TypesAssurances', $config);
    }
