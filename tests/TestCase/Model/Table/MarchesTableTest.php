...
use App\Model\Table\MarchesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\MarchesTable Test Case
 */
class MarchesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\MarchesTable
     */
    public $Marches;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Marches') ? [] : ['className' => MarchesTable::class];
        $this->Marches = TableRegistry::get('Marches', $config);
    }
