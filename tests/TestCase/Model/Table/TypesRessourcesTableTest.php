...
use App\Model\Table\TypesRessourcesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TypesRessourcesTable Test Case
 */
class TypesRessourcesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TypesRessourcesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TypesRessources') ? [] : ['className' => TypesRessourcesTable::class];
        $this->TypesRessources = TableRegistry::get('TypesRessources', $config);
    }
