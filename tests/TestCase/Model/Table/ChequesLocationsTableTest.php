...
use App\Model\Table\ChequesLocationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ChequesLocationsTable Test Case
 */
class ChequesLocationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ChequesLocationsTable
     */
    public $ChequesLocations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ChequesLocations') ? [] : ['className' => ChequesLocationsTable::class];
        $this->ChequesLocations = TableRegistry::get('ChequesLocations', $config);
    }
