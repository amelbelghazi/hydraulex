...
use App\Model\Table\ContratsPersonnelsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ContratsPersonnelsTable Test Case
 */
class ContratsPersonnelsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ContratsPersonnelsTable
     */
    public $ContratsPersonnels;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ContratsPersonnels') ? [] : ['className' => ContratsPersonnelsTable::class];
        $this->ContratsPersonnels = TableRegistry::get('ContratsPersonnels', $config);
    }
