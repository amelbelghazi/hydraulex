...
use App\Model\Table\GerantsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\GerantsTable Test Case
 */
class GerantsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\GerantsTable
     */
    public $Gerants;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Gerants') ? [] : ['className' => GerantsTable::class];
        $this->Gerants = TableRegistry::get('Gerants', $config);
    }
