...
use App\Model\Table\EntretiensRessourcesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EntretiensRessourcesTable Test Case
 */
class EntretiensRessourcesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EntretiensRessourcesTable
     */
    public $EntretiensRessources;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EntretiensRessources') ? [] : ['className' => EntretiensRessourcesTable::class];
        $this->EntretiensRessources = TableRegistry::get('EntretiensRessources', $config);
    }
    ...
    {
        unset($this->EntretiensRessources);
