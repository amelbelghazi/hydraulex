...
use App\Model\Table\PositionsChantiersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PositionsChantiersTable Test Case
 */
class PositionsChantiersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PositionsChantiersTable
     */
    public $PositionsChantiers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PositionsChantiers') ? [] : ['className' => PositionsChantiersTable::class];
        $this->PositionsChantiers = TableRegistry::get('PositionsChantiers', $config);
    }
