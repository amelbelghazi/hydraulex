...
use App\Model\Table\AttachementsTravauxAvenantsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AttachementsTravauxAvenantsTable Test Case
 */
class AttachementsTravauxAvenantsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AttachementsTravauxAvenantsTable
     */
    public $AttachementsTravauxAvenants;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AttachementsTravauxAvenants') ? [] : ['className' => AttachementsTravauxAvenantsTable::class];
        $this->AttachementsTravauxAvenants = TableRegistry::get('AttachementsTravauxAvenants', $config);
    }
    ...
    {
        unset($this->AttachementsTravauxAvenants);
