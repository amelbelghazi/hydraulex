...
use App\Model\Table\DettesLocationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DettesLocationsTable Test Case
 */
class DettesLocationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DettesLocationsTable
     */
    public $DettesLocations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DettesLocations') ? [] : ['className' => DettesLocationsTable::class];
        $this->DettesLocations = TableRegistry::get('DettesLocations', $config);
    }
