...
use App\Model\Table\ResponsablesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ResponsablesTable Test Case
 */
class ResponsablesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ResponsablesTable
     */
    public $Responsables;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Responsables') ? [] : ['className' => ResponsablesTable::class];
        $this->Responsables = TableRegistry::get('Responsables', $config);
    }
