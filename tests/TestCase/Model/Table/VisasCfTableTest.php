...
use App\Model\Table\VisasCfTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisasCfTable Test Case
 */
class VisasCfTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisasCfTable
     */
    public $VisasCf;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisasCf') ? [] : ['className' => VisasCfTable::class];
        $this->VisasCf = TableRegistry::get('VisasCf', $config);
    }
