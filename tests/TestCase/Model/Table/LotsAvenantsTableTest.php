...
use App\Model\Table\LotsAvenantsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\LotsAvenantsTable Test Case
 */
class LotsAvenantsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\LotsAvenantsTable
     */
    public $LotsAvenants;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('LotsAvenants') ? [] : ['className' => LotsAvenantsTable::class];
        $this->LotsAvenants = TableRegistry::get('LotsAvenants', $config);
    }
