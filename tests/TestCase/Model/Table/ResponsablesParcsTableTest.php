...
use App\Model\Table\ResponsablesParcsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ResponsablesParcsTable Test Case
 */
class ResponsablesParcsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ResponsablesParcsTable
     */
    public $ResponsablesParcs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ResponsablesParcs') ? [] : ['className' => ResponsablesParcsTable::class];
        $this->ResponsablesParcs = TableRegistry::get('ResponsablesParcs', $config);
    }
