...
use App\Model\Table\TypesGiftsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TypesGiftsTable Test Case
 */
class TypesGiftsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TypesGiftsTable
     */
    public $TypesGifts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TypesGifts') ? [] : ['className' => TypesGiftsTable::class];
        $this->TypesGifts = TableRegistry::get('TypesGifts', $config);
    }
