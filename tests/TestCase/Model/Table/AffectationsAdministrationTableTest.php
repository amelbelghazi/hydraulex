...
use App\Model\Table\AffectationsAdministrationTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AffectationsAdministrationTable Test Case
 */
class AffectationsAdministrationTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AffectationsAdministrationTable
     */
    public $AffectationsAdministration;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AffectationsAdministration') ? [] : ['className' => AffectationsAdministrationTable::class];
        $this->AffectationsAdministration = TableRegistry::get('AffectationsAdministration', $config);
    }
    ...
    {
        unset($this->AffectationsAdministration);
