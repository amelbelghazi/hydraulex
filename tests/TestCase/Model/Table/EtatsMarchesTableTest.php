...
use App\Model\Table\EtatsMarchesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EtatsMarchesTable Test Case
 */
class EtatsMarchesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EtatsMarchesTable
     */
    public $EtatsMarches;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EtatsMarches') ? [] : ['className' => EtatsMarchesTable::class];
        $this->EtatsMarches = TableRegistry::get('EtatsMarches', $config);
    }
