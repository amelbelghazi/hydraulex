...
use App\Model\Table\PartiesAvenantsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PartiesAvenantsTable Test Case
 */
class PartiesAvenantsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PartiesAvenantsTable
     */
    public $PartiesAvenants;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PartiesAvenants') ? [] : ['className' => PartiesAvenantsTable::class];
        $this->PartiesAvenants = TableRegistry::get('PartiesAvenants', $config);
    }
