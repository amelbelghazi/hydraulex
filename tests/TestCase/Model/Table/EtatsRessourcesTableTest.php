...
use App\Model\Table\EtatsRessourcesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EtatsRessourcesTable Test Case
 */
class EtatsRessourcesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EtatsRessourcesTable
     */
    public $EtatsRessources;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EtatsRessources') ? [] : ['className' => EtatsRessourcesTable::class];
        $this->EtatsRessources = TableRegistry::get('EtatsRessources', $config);
    }
