...
use App\Model\Table\BonsReceptionsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\BonsReceptionsTable Test Case
 */
class BonsReceptionsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\BonsReceptionsTable
     */
    public $BonsReceptions;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('BonsReceptions') ? [] : ['className' => BonsReceptionsTable::class];
        $this->BonsReceptions = TableRegistry::get('BonsReceptions', $config);
    }
