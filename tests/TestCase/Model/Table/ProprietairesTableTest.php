...
use App\Model\Table\ProprietairesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProprietairesTable Test Case
 */
class ProprietairesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ProprietairesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Proprietaires') ? [] : ['className' => ProprietairesTable::class];
        $this->Proprietaires = TableRegistry::get('Proprietaires', $config);
    }
