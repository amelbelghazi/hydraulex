...
use App\Model\Table\SituationsDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SituationsDetailsTable Test Case
 */
class SituationsDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\SituationsDetailsTable
     */
    public $SituationsDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('SituationsDetails') ? [] : ['className' => SituationsDetailsTable::class];
        $this->SituationsDetails = TableRegistry::get('SituationsDetails', $config);
    }
