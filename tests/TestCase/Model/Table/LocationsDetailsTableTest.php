...
use App\Model\Table\LocationsDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\LocationsDetailsTable Test Case
 */
class LocationsDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\LocationsDetailsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('LocationsDetails') ? [] : ['className' => LocationsDetailsTable::class];
        $this->LocationsDetails = TableRegistry::get('LocationsDetails', $config);
    }
