...
use App\Model\Table\OdssChantiersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OdssChantiersTable Test Case
 */
class OdssChantiersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OdssChantiersTable
     */
    public $OdssChantiers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OdssChantiers') ? [] : ['className' => OdssChantiersTable::class];
        $this->OdssChantiers = TableRegistry::get('OdssChantiers', $config);
    }
