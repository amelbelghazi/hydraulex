...
use App\Model\Table\TypesEtatsContratsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TypesEtatsContratsTable Test Case
 */
class TypesEtatsContratsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TypesEtatsContratsTable
     */
    public $TypesEtatsContrats;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TypesEtatsContrats') ? [] : ['className' => TypesEtatsContratsTable::class];
        $this->TypesEtatsContrats = TableRegistry::get('TypesEtatsContrats', $config);
    }
