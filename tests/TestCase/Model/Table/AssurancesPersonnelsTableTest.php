...
use App\Model\Table\AssurancesPersonnelsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AssurancesPersonnelsTable Test Case
 */
class AssurancesPersonnelsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AssurancesPersonnelsTable
     */
    public $AssurancesPersonnels;
     ...
     */
    public $fixtures = [
        'app.assurances_personnels',
        'app.assurances',
        'app.types_assurances',
        'app.personnels',
        'app.personnes',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AssurancesPersonnels') ? [] : ['className' => AssurancesPersonnelsTable::class];
        $this->AssurancesPersonnels = TableRegistry::get('AssurancesPersonnels', $config);
    }
    ...
    {
        unset($this->AssurancesPersonnels);
