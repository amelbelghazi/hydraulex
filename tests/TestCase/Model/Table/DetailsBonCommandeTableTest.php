...
use App\Model\Table\DetailsBonCommandeTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DetailsBonCommandeTable Test Case
 */
class DetailsBonCommandeTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DetailsBonCommandeTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DetailsBonCommande') ? [] : ['className' => DetailsBonCommandeTable::class];
        $this->DetailsBonCommande = TableRegistry::get('DetailsBonCommande', $config);
    }
