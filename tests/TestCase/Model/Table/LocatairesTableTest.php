...
use App\Model\Table\LocatairesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\LocatairesTable Test Case
 */
class LocatairesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\LocatairesTable
     */
    public $Locataires;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Locataires') ? [] : ['className' => LocatairesTable::class];
        $this->Locataires = TableRegistry::get('Locataires', $config);
    }
