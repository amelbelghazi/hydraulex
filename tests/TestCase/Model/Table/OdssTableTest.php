...
use App\Model\Table\OdssTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OdssTable Test Case
 */
class OdssTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OdssTable
     */
    public $Odss;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Odss') ? [] : ['className' => OdssTable::class];
        $this->Odss = TableRegistry::get('Odss', $config);
    }
