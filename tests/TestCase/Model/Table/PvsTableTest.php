...
use App\Model\Table\PvsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PvsTable Test Case
 */
class PvsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PvsTable
     */
    public $Pvs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Pvs') ? [] : ['className' => PvsTable::class];
        $this->Pvs = TableRegistry::get('Pvs', $config);
    }
