 ...
 * Attributions Model
 *
 * @property \App\Model\Table\SoumissionsTable|\Cake\ORM\Association\BelongsTo $Soumissions
 *
 ...
 * @method \App\Model\Entity\Attribution findOrCreate($search, callable $callback = null, $options = [])
 *
...
class AttributionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('attributions');
        $this->setDisplayField('id');
        $this->setPrimaryKey('id');

        $this->addBehavior('Timestamp');

        $this->belongsTo('Soumissions', [
    ...
    {
        $rules->add($rules->existsIn(['soumission_id'], 'Soumissions'));
