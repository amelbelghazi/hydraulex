<section class="content-header">
  <h1>
    <?php echo __('Categories Affaire'); ?>
  </h1>
  <ol class="breadcrumb">
    <li>
        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <dl class="dl-horizontal">
                                                                                                                <dt><?= __('Libelle') ?></dt>
                                        <dd>
                                            <?= h($categoriesAffaire->libelle) ?>
                                        </dd>
                                                                                                                                    
                                            
                                                                                                                                                            <dt><?= __('Modified By') ?></dt>
                                <dd>
                                    <?= $this->Number->format($categoriesAffaire->modified_by) ?>
                                </dd>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <?php if (!empty($categoriesAffaire->affaires)): ?>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <?php foreach ($categoriesAffaire->affaires as $affaires): ?>
                                <tr>
