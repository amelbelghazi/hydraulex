  ...
  <div class="row">
    ...
    <div class="col-md-12"> 
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?= $this->Form->create($devi, array('role' => 'form')) ?>
          <div class="box-body">
          <div class="form-group has-feedback">
          <label for="marche_id" class="col-sm-2 control-label">Marché</label>
          <div class="col-sm-10 " >
            <?php
              echo $this->Form->input('details_marche_id', ['label'=>false, 'options' => $detailsMarches, 'empty' => true, 'required', 'value'=>$details!=null ? $details->id : '', 'disabled']);
            ?>
          </div>
        </div>
        <div class="form-group has-feedback">
