                ...
                <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                            <?= h($formation->libelle) ?>
                                                                                                                                                            ...
                                                                                                                                                            <dt><?= __('Durée') ?></dt>
                                <dd>
                                    <?= $this->Number->format($formation->durée) ?>
                                </dd>
                                                                                                                <dt><?= __('Prix') ?></dt>
                                <dd>
                                    <?= $this->Number->format($formation->prix) ?>
                                </dd>
                                                                                                                <dt><?= __('Modified By') ?></dt>
                                <dd>
                                    <?= $this->Number->format($formation->modified_by) ?>
                                </dd>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <?php if (!empty($formation->formations_personnel)): ?>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <?php foreach ($formation->formations_personnel as $formationsPersonnel): ?>
                                <tr>
