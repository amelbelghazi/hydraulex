...
$file = 'src' . DS . 'Template' . DS . 'Element' . DS . 'nav-top.ctp';
      ...
      <li class="dropdown user user-menu">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-footer">
            <div class="pull-left">
            <?= $this->Html->link('<i class="btn btn-default btn-flat">'.__('Profile').'</i>', ['controller'=>'Users', 'action' => 'profile'], ['escape' => false]) ?>
            </div>
            <div class="pull-right">
            <?= $this->Html->link('<i class="btn btn-default btn-flat">'.__('Se déconnecter').'</i>', ['controller'=>'Users', 'action' => 'logout'], ['escape' => false]) ?>
            </div>
          </li>
        </ul>
      </li>
