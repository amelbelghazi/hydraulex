...
<div class="form-group has-feedback extraspace">
  ...
  <div class="col-sm-10">
    <?php echo $this->Form->input('datecommission', ['label'=>false, 'class' =>'pull-right', 'name' =>'datecommission', 'type' => 'text', 'id'=>'datepicker1', 'value'=>end($affaire->commissions)->datecommission]);?>
  </div>
</div>
<div class="form-group has-feedback extraspace">
