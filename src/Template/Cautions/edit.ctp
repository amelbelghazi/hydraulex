              ...
              <div class="tab-content">
                <div class="active tab-pane"  id="Information">
                  <div class="form-group has-feedback extraspace">
                    ...
                    <div class="col-sm-7">
                       <?php echo $this->Form->input('details_marche_id', ['id'=> 'marche','type'=> 'text', 'label'=>false, 'value'=>$caution->marche->has('details_marches')? end($caution->marche->details_marches)->intitule:'', 'disabled']);?> 
                    </div>
                    <div class="col-sm-2">
                       <?php echo $this->Form->input('montant-value', ['disabled' ,'id'=> 'montant-value','label'=>false,'value'=>end($caution->marche->details_marches)->montant, 'class' =>'form-control','empty' => true]);?>
                    </div>
                  ...
                  <div class="form-group has-feedback extraspace">
                    ...
                    <div class="col-sm-7">
                      <?php echo $this->Form->input('types_caution_id', ['id'=> 'typescautionedit','label'=>false,'options' => $typesCautions, 'empty' => true]);?>
                    </div>
                      <div class="col-sm-2">  
                      <?php echo $this->Form->input('pourcentage', ['disabled','id'=> 'pourcentage','label'=>false, 'empty' => true,'style'=>'padding-right: 10px;','value'=>$caution->types_caution->pourcentage]);?>
                    </div>
                    <div class="col-sm-1" style="    padding: 0px;">
                      <h5>%</h5>
                    </div>
