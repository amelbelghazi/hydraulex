        ...
        <?= $this->Form->create($commission, array('role' => 'form','type'=>'file')) ?>
          <div class="box-body">
            <div class="form-group has-feedback extraspace">
              ...
              <div class="col-sm-10">
                <?php echo $this->Form->input('affaire_id', ['label'=>false, 'options' => $affaires, 'empty' => true]); ?>
              </div>
            </div>
            <div class="form-group has-feedback extraspace">  
              <label for="datecommision" class="col-sm-2 control-label ">Date de la commission</label>
              <div class="col-sm-10">
                <?php echo $this->Form->input('datecommission', ['empty' => true, 'label'=>false, 'default' => '', 'class' => 'datepicker', 'type' => 'text']);?>
              </div>
            </div>
