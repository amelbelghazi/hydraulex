  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?= $this->Form->create($piecesIdentite, array('role' => 'form')) ?>
          <div class="box-body">
          <?php
            echo $this->Form->input('numero');
            echo $this->Form->input('type_piece_identite_id');
            echo $this->Form->input('datepiece', ['empty' => true, 'default' => '', 'class' => 'datepicker form-control', 'type' => 'text']);
