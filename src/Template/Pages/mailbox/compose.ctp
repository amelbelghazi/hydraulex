<!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo $this->Url->build(array('controller' => 'pages', 'action' => 'display', 'mailbox', 'mailbox')); ?>" class="btn btn-primary btn-block margin-bottom">Liste des e-mails</a>
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <div class="pull-right">
                <button type="button" class="btn btn-default"><i class="fa fa-pencil"></i> Brouillon</button>
