        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <dl class="dl-horizontal">
                                                                                                                <dt><?= __('Libellé') ?></dt>
                                        <dd>
                                            <?= h($typesPersonnel->libellé) ?>
                                        </dd>
                                                                                                                                    
                                            
                                                                                                                                                            <dt><?= __('Modified By') ?></dt>
                                <dd>
                                    <?= $this->Number->format($typesPersonnel->modified_by) ?>
                                </dd>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <?php if (!empty($typesPersonnel->personnels)): ?>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <?php foreach ($typesPersonnel->personnels as $personnels): ?>
                                <tr>
