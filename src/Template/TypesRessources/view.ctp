        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <dl class="dl-horizontal">
                                                                                                                <dt><?= __('Libelle') ?></dt>
                                        <dd>
                                            <?= h($typesRessource->libelle) ?>
                                        </dd>
                                                                                                                                    
                                            
                                                                                                                                                            <dt><?= __('Modified By') ?></dt>
                                <dd>
                                    <?= $this->Number->format($typesRessource->modified_by) ?>
                                </dd>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <?php if (!empty($typesRessource->ressources)): ?>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <?php foreach ($typesRessource->ressources as $ressources): ?>
                                <tr>
