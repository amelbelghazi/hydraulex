    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <?= $this->Form->create($location, array('role' => 'form')) ?>
          <?= $this->element('form_location'); ?>          
        <?= $this->Form->end() ?>
      </div>
    </div>
  </div>
</section>
<div aria-hidden="false" role="dialog" tabindex="-1" id="ProprietairePopup" class="modal leread-modal fade in">
  <div class="modal-dialog">
    <div id="login-content" class="modal-content" >
      <div class="modal-body">
        <?php
        echo $this->form->create($proprietaire,array('id'=>'formProprietaire', 'role'=>'form', 'url'=>array('controller'=>'Proprietaires', 'action' => 'add')));?>
...
<?php $this->end(); ?>
<script id="location-template" type="text/x-underscore-template">
    <?php echo $this->element('form_location_details');?>
</script>