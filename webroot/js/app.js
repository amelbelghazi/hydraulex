...
$(function () {
  ...
  if (o.sidebarPushMenu) {
    $.pushMenu.activate(o.sidebarToggleSelector);
  }
...
$(document).on('click','#SubmitMaitreOuvrage', function(e){
      alert('test'); 
      var formSerialize = $('#formMaitreOuvrage').serialize();
      $.ajax({
        beforeSend: function(xhr) {
          $('#SubmitMaitreOuvrage').text('Saving...');
          $('#SubmitMaitreOuvrage').attr('disabled', true);
...
(function ($) {
  ...
  $.fn.activateBox = function () {
    $.boxWidget.activate(this);
  };

  $.fn.toggleBox = function () {
    var button = $($.AdminLTE.boxWidget.selectors.collapse, this);
    $.boxWidget.collapse(button);
  };

  $.fn.removeBox = function () {
    var button = $($.AdminLTE.boxWidget.selectors.remove, this);
    $.boxWidget.remove(button);
  };
